...
- **space-title** names spaces from the status emoji plus folder and puts the Grok/agent session title on the subtitle. Pins the Grok session UUID (`grok-resume` resumes it after a pane reset)
